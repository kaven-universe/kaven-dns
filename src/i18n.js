...
const MESSAGES = {
  en: {
    ...
    'config.web_port_busy': 'Port {port} is already in use; pick another web port',
    'config.bind_invalid': 'Invalid listen address "{value}"; use an IP of this machine or 0.0.0.0',
  ...
  zh: {
    ...
    'config.web_port_busy': '端口 {port} 已被占用，请换一个 Web 端口',
    'config.bind_invalid': '监听地址 {value} 不合法，应为本机 IP 或 0.0.0.0',
